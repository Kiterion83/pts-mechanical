...
import WorkPackagesGanttPage from './pages/WorkPackagesGanttPage'  // AGGIUNTO: Gantt separato
              ...
              <ProjectProvider userId={session.user.id}>
                <Layout session={session}>
                  <Routes>
                    ...
                    <Route path="/work-packages/gantt" element={<WorkPackagesGanttPage />} />  {/* AGGIUNTO: Gantt separato */}
